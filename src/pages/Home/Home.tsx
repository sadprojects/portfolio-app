...
import { ArrowRight, Briefcase, Camera, Download, FolderGit2, Home as HomeIcon, Loader as LoaderIcon, Sparkles } from 'lucide-react';
...
const Home = memo(() => {
  ...
  const sections = [
    ...
    ...(hasContact ? [{ id: 'contact', label: 'Contact', icon: Sparkles }] : []),
  ];
